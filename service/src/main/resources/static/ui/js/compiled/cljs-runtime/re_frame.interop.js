...
return [(function (){var pred__50898 = cljs.core.instance_QMARK_;
var expr__50899 = reactive_val;
if(cljs.core.truth_((pred__50898.cljs$core$IFn$_invoke$arity$2 ? pred__50898.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__50899) : pred__50898.call(null,reagent.ratom.RAtom,expr__50899)))){
return "ra";
} else {
if(cljs.core.truth_((pred__50898.cljs$core$IFn$_invoke$arity$2 ? pred__50898.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__50899) : pred__50898.call(null,reagent.ratom.RCursor,expr__50899)))){
return "rc";
} else {
if(cljs.core.truth_((pred__50898.cljs$core$IFn$_invoke$arity$2 ? pred__50898.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__50899) : pred__50898.call(null,reagent.ratom.Reaction,expr__50899)))){
return "rx";
} else {
if(cljs.core.truth_((pred__50898.cljs$core$IFn$_invoke$arity$2 ? pred__50898.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__50899) : pred__50898.call(null,reagent.ratom.Track,expr__50899)))){
return "tr";
} else {
return "other";
}
