...
var len__4818__auto___56551 = arguments.length;
var i__4819__auto___56552 = (0);
while(true){
if((i__4819__auto___56552 < len__4818__auto___56551)){
args_arr__4839__auto__.push((arguments[i__4819__auto___56552]));

var G__56556 = (i__4819__auto___56552 + (1));
i__4819__auto___56552 = G__56556;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq56463){
var G__56464 = cljs.core.first(seq56463);
var seq56463__$1 = cljs.core.next(seq56463);
var G__56465 = cljs.core.first(seq56463__$1);
var seq56463__$2 = cljs.core.next(seq56463__$1);
var G__56466 = cljs.core.first(seq56463__$2);
var seq56463__$3 = cljs.core.next(seq56463__$2);
var G__56467 = cljs.core.first(seq56463__$3);
var seq56463__$4 = cljs.core.next(seq56463__$3);
var G__56468 = cljs.core.first(seq56463__$4);
var seq56463__$5 = cljs.core.next(seq56463__$4);
var G__56469 = cljs.core.first(seq56463__$5);
var seq56463__$6 = cljs.core.next(seq56463__$5);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56464,G__56465,G__56466,G__56467,G__56468,G__56469,seq56463__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__56519){
var vec__56520 = p__56519;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56520,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56520,(1),null);
