...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_63799 = (function (this$,ctx,n){
var x__4509__auto__ = (((this$ == null))?null:this$);
var m__4510__auto__ = (sci.impl.max_or_throw.max_or_throw[goog.typeOf(x__4509__auto__)]);
if((!((m__4510__auto__ == null)))){
return (m__4510__auto__.cljs$core$IFn$_invoke$arity$3 ? m__4510__auto__.cljs$core$IFn$_invoke$arity$3(this$,ctx,n) : m__4510__auto__.call(null,this$,ctx,n));
} else {
var m__4508__auto__ = (sci.impl.max_or_throw.max_or_throw["_"]);
if((!((m__4508__auto__ == null)))){
return (m__4508__auto__.cljs$core$IFn$_invoke$arity$3 ? m__4508__auto__.cljs$core$IFn$_invoke$arity$3(this$,ctx,n) : m__4508__auto__.call(null,this$,ctx,n));
} else {
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_63799(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__63716 = (n - (1));
var G__63717 = cljs.core.rest(s);
var G__63718 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__63716,G__63717,G__63718) : sci.impl.max_or_throw.take_STAR_.call(null,G__63716,G__63717,G__63718));
})());
} else {
return null;
}
...
return sci.impl.max_or_throw.take_STAR_(n,coll,sci.impl.max_or_throw.bottom(n,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"coll","coll",1647737163),(new cljs.core.Delay((function (){
return coll;
}),null)),new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("sci.error","realized-beyond-max","sci.error/realized-beyond-max",-1094268187),new cljs.core.Keyword(null,"realize-max","realize-max",-1846442543),n], null),cljs.core.select_keys(ctx,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"start-expression","start-expression",411256962),new cljs.core.Keyword(null,"expression","expression",202311876)], null))], 0))));
});
...
var this$__$1 = this;
return sci.impl.max_or_throw.take_or_throw(ctx,n,this$__$1);
}));
