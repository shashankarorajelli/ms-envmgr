...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_56928 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_56928(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_56945 = (function (runtime,key,spec){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_56945(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_56954 = (function (runtime,key){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_56954(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_56968 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_56968(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_56987 = (function (runtime,input,callback){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_56987(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_57007 = (function (runtime,code){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_57007(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__56901,callback){
var map__56902 = p__56901;
var map__56902__$1 = cljs.core.__destructure_map(map__56902);
var input = map__56902__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56902__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56902__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
