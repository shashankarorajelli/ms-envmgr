...
var G__63584 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__63585 = n;
var G__63586 = cljs.core.nnext(bs);
var G__63587 = true;
ret = G__63584;
n = G__63585;
bs = G__63586;
seen_rest_QMARK_ = G__63587;
continue;
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__63382_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4212__auto__ = mkns;
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
return cljs.core.namespace(p1__63382_SHARP_);
}
})(),cljs.core.name(p1__63382_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__63383_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4212__auto__ = mkns;
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
return cljs.core.namespace(p1__63383_SHARP_);
}
})(),cljs.core.name(p1__63383_SHARP_));
}));
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__63384_SHARP_,p2__63385_SHARP_,(function (){var fexpr__63508 = cljs.core.val(entry);
return (fexpr__63508.cljs$core$IFn$_invoke$arity$1 ? fexpr__63508.cljs$core$IFn$_invoke$arity$1(p2__63385_SHARP_) : fexpr__63508.call(null,p2__63385_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__63512 = cljs.core.key(entry);
return (fexpr__63512.cljs$core$IFn$_invoke$arity$1 ? fexpr__63512.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__63512.call(null,bes));
})());
...
var bv = ((cljs.core.contains_QMARK_(defaults,local))?sci.impl.utils.mark_eval_call((new cljs.core.List(null,cljs.core.get,(new cljs.core.List(null,gmap,(new cljs.core.List(null,bk,(new cljs.core.List(null,(defaults.cljs$core$IFn$_invoke$arity$1 ? defaults.cljs$core$IFn$_invoke$arity$1(local) : defaults.call(null,local)),null,(1),null)),(2),null)),(3),null)),(4),null))):sci.impl.utils.mark_eval_call((new cljs.core.List(null,cljs.core.get,(new cljs.core.List(null,gmap,(new cljs.core.List(null,bk,null,(1),null)),(2),null)),(3),null))));
var G__63612 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__63613 = cljs.core.next(bes);
ret = G__63612;
bes = G__63613;
continue;
} else {
...
var temp__5751__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__63389_SHARP_){
return (cljs.core.first(p1__63389_SHARP_) instanceof cljs.core.Keyword);
}),bents));
