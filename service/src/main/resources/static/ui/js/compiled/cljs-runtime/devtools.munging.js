...
var o51692 = temp__5751__auto__;
var temp__5751__auto____$1 = (o51692["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o51693 = temp__5751__auto____$1;
return (o51693["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__50993__auto__ = f;
return (o__50993__auto__["toString"]).call(o__50993__auto__);
} else {
return "";
}
...
try{var o__50993__auto___52336 = t;
(o__50993__auto___52336["cljs$lang$ctorPrWriter"]).call(o__50993__auto___52336,t,writer);
}catch (e51738){var __52337 = e51738;
}
...
var char_code = (function (){var o__50993__auto__ = (new String(char$));
return (o__50993__auto__["charCodeAt"]).call(o__50993__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__50993__auto__ = String;
return (o__50993__auto__["fromCharCode"]).call(o__50993__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__51780 = num_code;
switch (G__51780) {
case (1):
return (185);
...
var o__50993__auto__ = String;
return (o__50993__auto__["fromCharCode"]).call(o__50993__auto__,superscript_code);
});
/**
...
}catch (e51816){var _e__51000__auto__ = e51816;
return false;
}})())){
...
var vec__51818 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51818,(0),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var o51890 = temp__5751__auto__;
var temp__5751__auto____$1 = (o51890["dependencies_"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o51891 = temp__5751__auto____$1;
return (o51891["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4818__auto___52341 = arguments.length;
var i__4819__auto___52343 = (0);
while(true){
if((i__4819__auto___52343 < len__4818__auto___52341)){
args__4824__auto__.push((arguments[i__4819__auto___52343]));

var G__52345 = (i__4819__auto___52343 + (1));
i__4819__auto___52343 = G__52345;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__51917){
var vec__51920 = p__51917;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51920,(0),null);
...
var G__52349 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__52350 = cljs.core.butlast(remaining_tokens);
name_tokens = G__52349;
remaining_tokens = G__52350;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq51911){
var G__51912 = cljs.core.first(seq51911);
var seq51911__$1 = cljs.core.next(seq51911);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51912,seq51911__$1);
}));
...
var vec__51945 = cljs.core.split_with((function (p1__51941_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__51941_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51945,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51945,(1),null);
...
var vec__51970 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51970,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51970,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__52357 = cljs.core.rest(remaining_tokens);
var G__52358 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__52357;
name_tokens = G__52358;
continue;
} else {
...
var vec__51998 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51998,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51998,(1),null);
var vec__52001 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52001,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52001,(1),null);
var vec__52004 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52004,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52004,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52004,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52004,(3),null);
...
var vec__52029 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52029,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52029,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52029,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52029,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52029,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52029,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__52042 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52042,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52042,(1),null);
var vec__52048 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52048,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52048,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__52069 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__52069) : devtools.munging.parse_fn_info_deep.call(null,G__52069));
})()));
}
} else {
return fn_info;
...
var G__52386 = (arity + (1));
var G__52387 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__52122){
var vec__52123 = p__52122;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52123,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52123,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52161_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__52161_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52162_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__52162_SHARP_);
}),sorted_infos);
...
var args__4824__auto__ = [];
var len__4818__auto___52401 = arguments.length;
var i__4819__auto___52402 = (0);
while(true){
if((i__4819__auto___52402 < len__4818__auto___52401)){
args__4824__auto__.push((arguments[i__4819__auto___52402]));

var G__52404 = (i__4819__auto___52402 + (1));
i__4819__auto___52402 = G__52404;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__52180){
var vec__52181 = p__52180;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52181,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq52173){
var G__52174 = cljs.core.first(seq52173);
var seq52173__$1 = cljs.core.next(seq52173);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52174,seq52173__$1);
}));
...
var map__52214 = options;
var map__52214__$1 = cljs.core.__destructure_map(map__52214);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52214__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52214__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52214__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52214__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__52215 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52215,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52215,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52215,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52215,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52215,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52215,(5),null);
...
var o__50993__auto__ = f;
return (o__50993__auto__["getBasis"]).call(o__50993__auto__);
});
/**
...
}catch (e52234){var _e__51000__auto__ = e52234;
...
var G__52428 = (obj[cljs.core.first(path)]);
var G__52429 = cljs.core.rest(path);
obj = G__52428;
path = G__52429;
continue;
} else {
...
var _STAR_ = (function (accum,p__52278){
var vec__52279 = p__52278;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52279,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52279,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__52296){
var vec__52297 = p__52296;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52297,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52297,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52297,(2),null);
...
var post_process = (function (p__52312){
var vec__52313 = p__52312;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52313,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52313,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52306_SHARP_){
return (obj[cljs.core.first(p1__52306_SHARP_)]);
}),sorted_matches);
