...
re_com.simple_v_table.swap_BANG__sort_by_column = (function re_com$simple_v_table$swap_BANG__sort_by_column(p__53346,new_key_fn,new_comp){
var map__53348 = p__53346;
var map__53348__$1 = cljs.core.__destructure_map(map__53348);
var key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53348__$1,new cljs.core.Keyword(null,"key-fn","key-fn",-636154479));
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53348__$1,new cljs.core.Keyword(null,"order","order",-1254677256));
...
re_com.simple_v_table.column_header_item = (function re_com$simple_v_table$column_header_item(p__53362,parts,sort_by_column){
var map__53363 = p__53362;
var map__53363__$1 = cljs.core.__destructure_map(map__53363);
var column = map__53363__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53363__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var row_label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53363__$1,new cljs.core.Keyword(null,"row-label-fn","row-label-fn",1457434308));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53363__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53363__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53363__$1,new cljs.core.Keyword(null,"align","align",1964212802));
var vertical_align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53363__$1,new cljs.core.Keyword(null,"vertical-align","vertical-align",651007333));
var header_label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53363__$1,new cljs.core.Keyword(null,"header-label","header-label",765876429));
var sort_by = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53363__$1,new cljs.core.Keyword(null,"sort-by","sort-by",-322599303));
var map__53364 = sort_by;
var map__53364__$1 = cljs.core.__destructure_map(map__53364);
var key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__53364__$1,new cljs.core.Keyword(null,"key-fn","key-fn",-636154479),row_label_fn);
var comp = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__53364__$1,new cljs.core.Keyword(null,"comp","comp",1191953630),cljs.core.compare);
var map__53365 = cljs.core.deref(sort_by_column);
var map__53365__$1 = cljs.core.__destructure_map(map__53365);
var current_key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53365__$1,new cljs.core.Keyword(null,"key-fn","key-fn",-636154479));
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53365__$1,new cljs.core.Keyword(null,"order","order",-1254677256));
...
return null;
})], null),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"simple-column-header","simple-column-header",-1241463404),new cljs.core.Keyword(null,"attr","attr",-604132353)], null))], 0))], null),(function (){var iter__4611__auto__ = (function re_com$simple_v_table$column_header_renderer_$_iter__53378(s__53379){
return (new cljs.core.LazySeq(null,(function (){
var s__53379__$1 = s__53379;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__53379__$1);
if(temp__5753__auto__){
var s__53379__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__53379__$2)){
var c__4609__auto__ = cljs.core.chunk_first(s__53379__$2);
var size__4610__auto__ = cljs.core.count(c__4609__auto__);
var b__53381 = cljs.core.chunk_buffer(size__4610__auto__);
if((function (){var i__53380 = (0);
while(true){
if((i__53380 < size__4610__auto__)){
var column = cljs.core._nth(c__4609__auto__,i__53380);
cljs.core.chunk_append(b__53381,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.column_header_item,column,parts,sort_by_column], null));

var G__53420 = (i__53380 + (1));
i__53380 = G__53420;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__53381),re_com$simple_v_table$column_header_renderer_$_iter__53378(cljs.core.chunk_rest(s__53379__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__53381),null);
}
} else {
var column = cljs.core.first(s__53379__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.column_header_item,column,parts,sort_by_column], null),re_com$simple_v_table$column_header_renderer_$_iter__53378(cljs.core.rest(s__53379__$2)));
}
} else {
return null;
}
...
return iter__4611__auto__(columns);
})());
});
/**
 * Render a single row item (column) of a single row
 */
re_com.simple_v_table.row_item = (function re_com$simple_v_table$row_item(row,p__53394,cell_style,parts){
var map__53395 = p__53394;
var map__53395__$1 = cljs.core.__destructure_map(map__53395);
var column = map__53395__$1;
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53395__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53395__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53395__$1,new cljs.core.Keyword(null,"align","align",1964212802));
var vertical_align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53395__$1,new cljs.core.Keyword(null,"vertical-align","vertical-align",651007333));
var row_label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53395__$1,new cljs.core.Keyword(null,"row-label-fn","row-label-fn",1457434308));
...
return null;
}):null)], null),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"simple-row","simple-row",-252554766),new cljs.core.Keyword(null,"attr","attr",-604132353)], null))], 0))], null),(function (){var iter__4611__auto__ = (function re_com$simple_v_table$row_renderer_$_iter__53401(s__53402){
return (new cljs.core.LazySeq(null,(function (){
var s__53402__$1 = s__53402;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__53402__$1);
if(temp__5753__auto__){
var s__53402__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__53402__$2)){
var c__4609__auto__ = cljs.core.chunk_first(s__53402__$2);
var size__4610__auto__ = cljs.core.count(c__4609__auto__);
var b__53404 = cljs.core.chunk_buffer(size__4610__auto__);
if((function (){var i__53403 = (0);
while(true){
if((i__53403 < size__4610__auto__)){
var column = cljs.core._nth(c__4609__auto__,i__53403);
cljs.core.chunk_append(b__53404,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.row_item,row,column,cell_style,parts], null));

var G__53421 = (i__53403 + (1));
i__53403 = G__53421;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__53404),re_com$simple_v_table$row_renderer_$_iter__53401(cljs.core.chunk_rest(s__53402__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__53404),null);
}
} else {
var column = cljs.core.first(s__53402__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.row_item,row,column,cell_style,parts], null),re_com$simple_v_table$row_renderer_$_iter__53401(cljs.core.rest(s__53402__$2)));
}
} else {
return null;
}
...
re_com.simple_v_table.simple_v_table_parts_desc = ((re_com.config.include_args_desc_QMARK_)?cljs.core.into.cljs$core$IFn$_invoke$arity$2(re_com.simple_v_table.simple_v_table_exclusive_parts_desc,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53405_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(p1__53405_SHARP_,new cljs.core.Keyword(null,"level","level",1290497552),cljs.core.inc);
...
var len__4818__auto___53422 = arguments.length;
var i__4819__auto___53423 = (0);
while(true){
if((i__4819__auto___53423 < len__4818__auto___53422)){
args__4824__auto__.push((arguments[i__4819__auto___53423]));

var G__53424 = (i__4819__auto___53423 + (1));
i__4819__auto___53423 = G__53424;
continue;
} else {
}
break;
...
return re_com.simple_v_table.simple_v_table.cljs$core$IFn$_invoke$arity$variadic(argseq__4825__auto__);
});

(re_com.simple_v_table.simple_v_table.cljs$core$IFn$_invoke$arity$variadic = (function (p__53411){
var map__53412 = p__53411;
var map__53412__$1 = cljs.core.__destructure_map(map__53412);
var args = map__53412__$1;
var src = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53412__$1,new cljs.core.Keyword(null,"src","src",-1651076051));
var or__4212__auto__ = (((!(goog.DEBUG)))?null:re_com.validate.validate_args(re_com.validate.extract_arg_data(re_com.simple_v_table.simple_v_table_args_desc),args));
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
var sort_by_column = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(null);
return (function() { 
var re_com$simple_v_table$simple_v_table_render__delegate = function (p__53413){
var map__53414 = p__53413;
var map__53414__$1 = cljs.core.__destructure_map(map__53414);
var args__$1 = map__53414__$1;
var cell_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53414__$1,new cljs.core.Keyword(null,"cell-style","cell-style",1087536089));
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53414__$1,new cljs.core.Keyword(null,"model","model",331153215));
var on_leave_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53414__$1,new cljs.core.Keyword(null,"on-leave-row","on-leave-row",1361264390));
var columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53414__$1,new cljs.core.Keyword(null,"columns","columns",1998437288));
var parts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53414__$1,new cljs.core.Keyword(null,"parts","parts",849007691));
var on_enter_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53414__$1,new cljs.core.Keyword(null,"on-enter-row","on-enter-row",-139996948));
var row_height = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__53414__$1,new cljs.core.Keyword(null,"row-height","row-height",527360749),(31));
var max_width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53414__$1,new cljs.core.Keyword(null,"max-width","max-width",-1939924051));
var src__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53414__$1,new cljs.core.Keyword(null,"src","src",-1651076051));
var on_click_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53414__$1,new cljs.core.Keyword(null,"on-click-row","on-click-row",-383826673));
var table_row_line_color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__53414__$1,new cljs.core.Keyword(null,"table-row-line-color","table-row-line-color",680569135),"#EAEEF1");
var table_padding = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__53414__$1,new cljs.core.Keyword(null,"table-padding","table-padding",-702873839),(19));
var column_header_height = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__53414__$1,new cljs.core.Keyword(null,"column-header-height","column-header-height",-1680092558),(31));
var debug_as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53414__$1,new cljs.core.Keyword(null,"debug-as","debug-as",283322354));
var max_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53414__$1,new cljs.core.Keyword(null,"max-rows","max-rows",-2131113613));
var row_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53414__$1,new cljs.core.Keyword(null,"row-style","row-style",1352472052));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53414__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var fixed_column_border_color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__53414__$1,new cljs.core.Keyword(null,"fixed-column-border-color","fixed-column-border-color",2036669142),"#BBBEC0");
var column_header_renderer = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__53414__$1,new cljs.core.Keyword(null,"column-header-renderer","column-header-renderer",-1886265578),re_com.simple_v_table.column_header_renderer);
var fixed_column_count = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__53414__$1,new cljs.core.Keyword(null,"fixed-column-count","fixed-column-count",721535030),(0));
var or__4212__auto____$1 = (((!(goog.DEBUG)))?null:re_com.validate.validate_args(re_com.validate.extract_arg_data(re_com.simple_v_table.simple_v_table_args_desc),args__$1));
if(cljs.core.truth_(or__4212__auto____$1)){
return or__4212__auto____$1;
} else {
var fcc_bounded = (function (){var x__4298__auto__ = fixed_column_count;
var y__4299__auto__ = cljs.core.count(columns);
...
var map__53415 = temp__5751__auto__;
var map__53415__$1 = cljs.core.__destructure_map(map__53415);
var key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53415__$1,new cljs.core.Keyword(null,"key-fn","key-fn",-636154479));
var comp = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__53415__$1,new cljs.core.Keyword(null,"comp","comp",1191953630),cljs.core.compare);
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53415__$1,new cljs.core.Keyword(null,"order","order",-1254677256));
...
return new cljs.core.PersistentVector(null, 13, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.box,new cljs.core.Keyword(null,"src","src",-1651076051),src__$1,new cljs.core.Keyword(null,"debug-as","debug-as",283322354),(function (){var or__4212__auto____$2 = debug_as;
...
while (G__53435__i < G__53435__a.length) {G__53435__a[G__53435__i] = arguments[G__53435__i + 0]; ++G__53435__i;}
  p__53413 = new cljs.core.IndexedSeq(G__53435__a,0,null);
} 
return re_com$simple_v_table$simple_v_table_render__delegate.call(this,p__53413);};
re_com$simple_v_table$simple_v_table_render.cljs$lang$maxFixedArity = 0;
re_com$simple_v_table$simple_v_table_render.cljs$lang$applyTo = (function (arglist__53436){
var p__53413 = cljs.core.seq(arglist__53436);
return re_com$simple_v_table$simple_v_table_render__delegate(p__53413);
});
...
/** @this {Function} */
(re_com.simple_v_table.simple_v_table.cljs$lang$applyTo = (function (seq53410){
var self__4806__auto__ = this;
return self__4806__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq53410));
}));
