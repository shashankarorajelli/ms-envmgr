...
var G__49914 = o;
goog.object.set(G__49914,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__49915 = o;
goog.object.set(G__49915,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__49958__i < G__49958__a.length) {G__49958__a[G__49958__i] = arguments[G__49958__i + 0]; ++G__49958__i;}
  args = new cljs.core.IndexedSeq(G__49958__a,0,null);
} 
...
var G__49916 = props;
var G__49916__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__49916,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__49916);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__49916__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4212__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__49917 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__49917,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__49917;
}
})(),id_class);
...
var G__49918 = (cljs.core.count(argv) - first_child);
switch (G__49918) {
case (0):
...
var vec__49919 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49919,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49919,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49919,(2),null);
...
var temp__5757__auto___49965 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___49965 == null)){
} else {
var key_49966 = temp__5757__auto___49965;
(jsprops.key = key_49966);
}
...
var temp__5757__auto___49972 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___49972 == null)){
} else {
var key_49973 = temp__5757__auto___49972;
(jsprops.key = key_49973);
}
...
var temp__5757__auto___49974 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___49974 == null)){
} else {
var key_49975 = temp__5757__auto___49974;
(jsprops.key = key_49975);
}
...
var temp__5757__auto___49981 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___49981 == null)){
} else {
var key_49982 = temp__5757__auto___49981;
(jsprops.key = key_49982);
}
...
var temp__5757__auto___49983 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___49983 == null)){
} else {
var key_49984 = temp__5757__auto___49983;
(jsprops.key = key_49984);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49922_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__49922_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__49923 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49923,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49923,(1),null);
...
break;
default:
var G__49992 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__49993 = compiler;
v = G__49992;
compiler = G__49993;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template49929 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template49929 = (function (opts,id,fn_to_element,parse_fn,meta49930){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template49929.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_49931,meta49930__$1){
var self__ = this;
var _49931__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template49929(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta49930__$1));
}));

(reagent.impl.template.t_reagent$impl$template49929.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_49931){
var self__ = this;
var _49931__$1 = this;
return self__.meta49930;
}));

(reagent.impl.template.t_reagent$impl$template49929.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template49929.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template49929.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template49929.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template49929.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template49929.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta49930","meta49930",-908235211,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template49929.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template49929.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template49929");

(reagent.impl.template.t_reagent$impl$template49929.cljs$lang$ctorPrWriter = (function (this__4450__auto__,writer__4451__auto__,opt__4452__auto__){
return cljs.core._write(writer__4451__auto__,"reagent.impl.template/t_reagent$impl$template49929");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template49929.
 */
reagent.impl.template.__GT_t_reagent$impl$template49929 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template49929(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta49930){
return (new reagent.impl.template.t_reagent$impl$template49929(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta49930));
});

}

return (new reagent.impl.template.t_reagent$impl$template49929(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
