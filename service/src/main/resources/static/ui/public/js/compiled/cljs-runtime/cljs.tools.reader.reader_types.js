...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_52770 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_52770(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_52775 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_52775(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_52779 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_52779(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_52784 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_52784(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_52791 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_52791(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_52794 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_52794(reader);
}
});
...
var G__52873 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__52874 = s.append(c);
c = G__52873;
s = G__52874;
continue;
}
