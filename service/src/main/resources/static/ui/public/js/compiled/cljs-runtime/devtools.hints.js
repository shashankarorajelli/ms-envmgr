...
var map__52373 = top_item;
var map__52373__$1 = cljs.core.__destructure_map(map__52373);
...
}catch (e52372){var _e = e52372;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___52417 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5751__auto___52417)){
var seen_errors_52418 = temp__5751__auto___52417;
if(cljs.core.truth_(seen_errors_52418.has(self))){
} else {
seen_errors_52418.add(self);

var temp__5753__auto___52419 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5753__auto___52419)){
var sense_52420 = temp__5753__auto___52419;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_52420)].join(''));
} else {
}
}
} else {
