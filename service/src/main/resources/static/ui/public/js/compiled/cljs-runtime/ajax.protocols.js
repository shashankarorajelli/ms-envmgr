...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_68783 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_68783(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_68809 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_68809(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_68817 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_68817(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_68822 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_68822(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_68832 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_68832(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_68839 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_68839(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_68848 = (function (this$,header){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_68848(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_68851 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_68851(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_68859 = (function (this$,request){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_68859(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_68865 = (function (this$,response){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_68865(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4463__auto__,k68661,else__4464__auto__){
var self__ = this;
var this__4463__auto____$1 = this;
var G__68669 = k68661;
var G__68669__$1 = (((G__68669 instanceof cljs.core.Keyword))?G__68669.fqn:null);
switch (G__68669__$1) {
case "status":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k68661,else__4464__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4484__auto__,p__68673){
var vec__68674 = p__68673;
var k__4485__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68674,(0),null);
var v__4486__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68674,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this68662,other68663){
var self__ = this;
var this68662__$1 = this;
return (((!((other68663 == null)))) && ((((this68662__$1.constructor === other68663.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68662__$1.status,other68663.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68662__$1.body,other68663.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68662__$1.status_text,other68663.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68662__$1.headers,other68663.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68662__$1.was_aborted,other68663.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68662__$1.__extmap,other68663.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4468__auto__,k68661){
var self__ = this;
var this__4468__auto____$1 = this;
var G__68723 = k68661;
var G__68723__$1 = (((G__68723 instanceof cljs.core.Keyword))?G__68723.fqn:null);
switch (G__68723__$1) {
case "status":
case "body":
case "status-text":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k68661);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4469__auto__,k__4470__auto__,G__68660){
var self__ = this;
var this__4469__auto____$1 = this;
var pred__68725 = cljs.core.keyword_identical_QMARK_;
var expr__68726 = k__4470__auto__;
if(cljs.core.truth_((pred__68725.cljs$core$IFn$_invoke$arity$2 ? pred__68725.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__68726) : pred__68725.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__68726)))){
return (new ajax.protocols.Response(G__68660,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__68725.cljs$core$IFn$_invoke$arity$2 ? pred__68725.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__68726) : pred__68725.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__68726)))){
return (new ajax.protocols.Response(self__.status,G__68660,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__68725.cljs$core$IFn$_invoke$arity$2 ? pred__68725.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__68726) : pred__68725.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__68726)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__68660,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__68725.cljs$core$IFn$_invoke$arity$2 ? pred__68725.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__68726) : pred__68725.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__68726)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__68660,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__68725.cljs$core$IFn$_invoke$arity$2 ? pred__68725.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__68726) : pred__68725.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__68726)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__68660,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4470__auto__,G__68660),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4460__auto__,G__68660){
var self__ = this;
var this__4460__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__68660,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__68664){
var extmap__4501__auto__ = (function (){var G__68747 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__68664,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__68664)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__68747);
} else {
return G__68747;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__68664),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__68664),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__68664),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__68664),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__68664),null,cljs.core.not_empty(extmap__4501__auto__),null));
});
