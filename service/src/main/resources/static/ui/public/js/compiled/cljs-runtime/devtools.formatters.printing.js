...
var len__4818__auto___52505 = arguments.length;
var i__4819__auto___52506 = (0);
while(true){
if((i__4819__auto___52506 < len__4818__auto___52505)){
args__4824__auto__.push((arguments[i__4819__auto___52506]));

var G__52507 = (i__4819__auto___52506 + (1));
i__4819__auto___52506 = G__52507;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq52430){
var G__52431 = cljs.core.first(seq52430);
var seq52430__$1 = cljs.core.next(seq52430);
var G__52432 = cljs.core.first(seq52430__$1);
var seq52430__$2 = cljs.core.next(seq52430__$1);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52431,G__52432,seq52430__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__52450_SHARP_){
return (!((cljs.core.meta(p1__52450_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52466__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e52467){var _e__51000__auto__ = e52467;
return false;
}})();
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
...
}catch (e52471){var _e__51000__auto__ = e52471;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__52479 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__52480 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__52480);

try{var map__52482 = opts;
var map__52482__$1 = cljs.core.__destructure_map(map__52482);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52482__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__52479);
}});
...
var temp__5751__auto___52534 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___52534)){
var managed_print_level_52535 = temp__5751__auto___52534;
var _STAR_print_level_STAR__orig_val__52493_52536 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__52494_52537 = managed_print_level_52535;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__52494_52537);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__52484_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__52484_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__52493_52536);
}} else {
job_fn();
}
