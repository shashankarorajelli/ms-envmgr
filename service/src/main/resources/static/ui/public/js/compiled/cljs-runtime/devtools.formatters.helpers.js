...
var G__52415 = devtools.prefs.pref(v);
v = G__52415;
continue;
} else {
return v;
...
}catch (e52342){var _e__51000__auto__ = e52342;
return false;
}})();
...
}catch (e52347){var _e__51000__auto__ = e52347;
return false;
}})();
...
}catch (e52351){var _e__51000__auto__ = e52351;
return false;
}}
}
});
...
var vec__52377 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52377,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52377,(1),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__52385_SHARP_);
}),template);
});
