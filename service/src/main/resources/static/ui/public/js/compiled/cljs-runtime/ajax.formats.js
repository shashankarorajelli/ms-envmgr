...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__69373){
var map__69374 = p__69373;
var map__69374__$1 = cljs.core.__destructure_map(map__69374);
var request = map__69374__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69374__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__69377 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__69377.cljs$core$IFn$_invoke$arity$1 ? fexpr__69377.cljs$core$IFn$_invoke$arity$1(response) : fexpr__69377.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__69378 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__69378.cljs$core$IFn$_invoke$arity$1 ? fexpr__69378.cljs$core$IFn$_invoke$arity$1(response) : fexpr__69378.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__69379){
var map__69380 = p__69379;
var map__69380__$1 = cljs.core.__destructure_map(map__69380);
var request = map__69380__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69380__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
